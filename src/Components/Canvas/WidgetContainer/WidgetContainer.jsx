...
function WidgetContainer({ id, children, onClick }) {
    ...
    return (
        <div id={id} className={widgetContainerClass} onClick={onClick} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} >
            {children}
        </div>
    );
}
